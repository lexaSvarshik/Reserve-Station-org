reagent-name-stasizium = стазициум
...
reagent-name-fleshmend = плоть генокрада
...
reagent-popup-fleshmend = Наше тело изгибается и принимает нужную форму.
...
reagent-popup-panacea = Яд вытекает из нас на пол.
...
reagent-popup-lingdrenaline = Всё наше тело сильно дрожит.
...
reagent-desc-immurin = Химическое вещество, которое укрепляет вашу иммунную систему, заставляя её работать быстрее и усерднее. Эффект сохраняется в течение некоторого времени даже после того, как химическое вещество усвоится. Вкус ужасен.

reagent-name-spaceacilin = космоацилин
...
reagent-desc-devirate = Противовирусное лекарство. Слабо токсично.
