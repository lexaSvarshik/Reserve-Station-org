...
execution-popup-gun-empty = {CAPITALIZE($weapon)} издаёт щелчок.

suicide-popup-gun-initial-internal = Вы приставляете дуло {$weapon} в свой рот.
suicide-popup-gun-initial-external = {$attacker} приставляет дуло {$weapon} в свой рот.
